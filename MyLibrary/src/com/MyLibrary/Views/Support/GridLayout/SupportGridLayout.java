...
package com.MyLibrary.Views.Support.GridLayout;
...
/**
 * 
 * Be SURE to implement the res/values/attrs.xml and the res/values/dimens.xml
 * 
 */
 ...
 */
public class SupportGridLayout extends ViewGroup {
    ...
    /**
     * This constant is an {@link #setAlignmentMode alignmentMode}.
    ...
    static final String TAG = SupportGridLayout.class.getName();
     ...
     * {@inheritDoc}
     */
    public SupportGridLayout(Context context, AttributeSet attrs, int defStyle) {
     ...
     * {@inheritDoc}
     */
    public SupportGridLayout(Context context, AttributeSet attrs) {
     ...
     * {@inheritDoc}
     */
    public SupportGridLayout(Context context) {
    ...
    final class Axis {
        ...
        private void computeGroupBounds() {
            ...
            for (int i = 0, N = getChildCount(); i < N; i++) {
                ...
                LayoutParams lp = getLayoutParams(c);
                Spec spec = horizontal ? lp.columnSpec : lp.rowSpec;
                groupBounds.getValue(i).include(c, spec, SupportGridLayout.this, this);
            }
        }
    ...
    */
    static class Bounds {
        ...
        protected final void include(View c, Spec spec, SupportGridLayout gridLayout, Axis axis) {
    ...
    public static class Spec {
        static final Spec UNDEFINED = spec(SupportGridLayout.UNDEFINED);
